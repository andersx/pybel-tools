...
from ...constants import DBSNP_PATTERN
...
NIFT_URL = 'http://belief.scai.fraunhofer.de/openbel/repository/namespaces/NIFT.belns'
...
if __name__ == '__main__':
    ...
    with open(os.path.join(bms_base, 'aetionomy', 'alzheimers', 'neurommsigdb_ad.bel'), 'w') as file:
        write_neurommsig_bel(file, ad_df, mesh_alzheimer, nift_values)
